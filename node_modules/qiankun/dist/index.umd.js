(function (global, factory) {
	...
	var unscopedGlobals = [].concat(_toConsumableArray(without_1.apply(void 0, [globals].concat(scopedGlobals))), ['requestAnimationFrame']);
	var lexicalGlobals = [].concat(_toConsumableArray(unscopedGlobals), scopedGlobals);
