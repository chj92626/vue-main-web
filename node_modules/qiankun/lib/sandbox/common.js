...
exports.lexicalGlobals = void 0;
exports.setCurrentRunningApp = setCurrentRunningApp;
exports.unscopedGlobals = void 0;
...
var unscopedGlobals = [].concat((0, _toConsumableArray2.default)(_without2.default.apply(void 0, [_globals.globals].concat(scopedGlobals))), ['requestAnimationFrame']);
exports.unscopedGlobals = unscopedGlobals;
var lexicalGlobals = [].concat((0, _toConsumableArray2.default)(unscopedGlobals), scopedGlobals);
exports.lexicalGlobals = lexicalGlobals;
