...
var scopedGlobals = ['window', 'self', 'globalThis', 'top', 'parent', 'hasOwnProperty', 'document', 'eval'];
export var unscopedGlobals = [].concat(_toConsumableArray(_without.apply(void 0, [globals].concat(scopedGlobals))), ['requestAnimationFrame']);
export var lexicalGlobals = [].concat(_toConsumableArray(unscopedGlobals), scopedGlobals);
